...
let DATA1 = [
  ...
  { title: '一起去爬山看夜景吧', date: '11/17 18:00', type: '活动', active: '100' },
  { title: '元旦晚会节目征集，快来报名', date: '11/18 8:00', type: '征集', active: '1900' },
  { title: '你是否支持共享单车进入园区', date: '11/20 9:00', type: '讨论', active: '4900' },
  { title: '和谐园区，快乐工作主题周开始啦', date: '11/22 9:00', type: '新闻', active: '4900' }
];
let DATA0 = [
